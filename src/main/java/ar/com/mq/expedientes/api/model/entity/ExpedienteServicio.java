...
public class ExpedienteServicio extends Expediente{
    ...
    public ExpedienteServicio(Long id, String numero, String referencia, LocalDateTime fechaCaratulacion, String descripcion, String codigoTramite, String tipo, String estado, Integer cantidadFojas, BigDecimal monto) {
