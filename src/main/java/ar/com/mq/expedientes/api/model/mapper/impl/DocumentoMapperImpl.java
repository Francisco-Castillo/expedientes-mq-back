...
public class DocumentoMapperImpl implements DocumentoMapper {
	...
	public Documento toEntity(DocumentoDTO dto) {
		...
		return Documento.builder().id(dto.getId()).fechaSubida(dto.getFechaSubida())
				.observaciones(dto.getObservaciones()).nombre(dto.getNombre()).ubicacion(dto.getUbicacion())
				...
				.tipoArchivo(dto.getTipoArchivo()).build();
	}
	...
	public DocumentoDTO toDTO(Documento entity) {
		if (ObjectUtils.isEmpty(entity))
			return null;
		return DocumentoDTO.builder().id(entity.getId()).ubicacion(entity.getUbicacion()).nombre(entity.getNombre())
				.expedienteId(entity.getExpediente().getId()).tipoDocumentoId(entity.getTipoDocumento().getId())
				.tipoArchivo(entity.getTipoArchivo()).fechaSubida(entity.getFechaSubida())
